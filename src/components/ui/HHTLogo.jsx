  ...
  return (
    <div className={`inline-flex items-center gap-2.5 select-none ${className}`}>
      ...
      >
        ...
        >
          <defs>
            <linearGradient id="hhtGarnet" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#C0392B" />
              <stop offset="50%" stopColor="#96281B" />
              <stop offset="100%" stopColor="#6B1110" />
            </linearGradient>
            <linearGradient id="hhtGold" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#F1C40F" />
              <stop offset="100%" stopColor="#D4AC0D" />
            </linearGradient>
            <linearGradient id="hhtShield" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#E74C3C" stopOpacity="0.15" />
              <stop offset="100%" stopColor="#96281B" stopOpacity="0.03" />
            </linearGradient>
          ...
          <circle cx="50" cy="30" r="5" fill="url(#hhtGold)" filter="url(#glow)" />
